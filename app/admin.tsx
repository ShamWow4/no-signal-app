...
export default function AdminBroadcastScreen() {
  ...
  const handleSendBroadcast = async () => {
    ...
    try {
      ...
      Alert.alert('Success', 'Broadcast pushed successfully!');
      setTitle('');
      setBody('');
    } catch (error) {
      console.error(error);
  ...
  const renderTargetOption = (value, label, icon, color) => (
    <TouchableOpacity
      style={[
        styles.targetOption,
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.warningBox}>
            <Ionicons name="warning" size={24} color="#FF9F0A" />
            <Text style={styles.warningText}>
              Warning: This tool sends real push notifications to physical devices. Use with caution.
            </Text>
          </View>
            ...
            >
              {sending ? (
                ...
                <>
                  ...
                  <Text style={styles.primaryButtonText}>Send Blast</Text>
                </>
              )}
            </TouchableOpacity>
